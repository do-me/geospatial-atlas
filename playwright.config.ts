...
export default defineConfig({
  ...
  projects: [
    ...
    },
    {
      ...
      name: "perf-chrome",
      testMatch: /(perf-75m|perf-cold-load|pan-visibility|pan-screencast|wg-sweep|europe-300m|gpu-soak|reload-soak|pan-release-soak|pan-rapid-release|tooltip-latency|pan-zoom-out|u32-precision)\.spec\.ts$/,
      timeout: 20 * 60 * 1000,
      use: {
        channel: "chrome",
        launchOptions: {
